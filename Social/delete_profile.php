    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div id="content_timeline">
                <form action="delete_profile.php?id=<?php echo $user_id;?>" method="post" id="f" align="center">
                <br/><br/><br/><br/><br/><br/><h2>Are you sure you want to delete your profile? </h2><br/><br/>
                <h4> Deleting profile will delete all your posts, pages and messages...</h4><br/><br/><br/><br/>
                <br/><br/><br/><br/><br/>
                <input type="submit" name="delete" value="YES"/>
                <input type="submit" name="no" value="NO"/>

                </form>
                    <?php include("functions/functions_delete.php") ?>
