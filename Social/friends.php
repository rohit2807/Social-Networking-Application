    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div id="content_timeline">
                ...
                $get_friends="select * from users ORDER by 1 DESC LIMIT $start_from,$per_page";
                ...
                echo"
                 <a href ='user_profile.php?u_id=$user_id'> </br> 
                <img src='user/user_images/$user_image' width='100' height='100' title='$user_name' />
                    
                <p><strong>Name:</strong> $user_name</p>
                    
                ";
                }
                include("members_page.php");
                ?>
