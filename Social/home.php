    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div id="content_timeline">
                ...
                <h2>Make Post </h2>
                <textarea cols="98" rows="5" name="content" placeholder="What's on your mind?" required="required"></textarea><br/>
                <input type="submit" name="sub" value="Share on Timeline"/>
                </form>
                <?php 
                include("functions/functions.php");
                ?>
                
                    </br><center><h2>  Most Recent Posts </h2></center></br>
                    <?php include("functions/function_getposts.php") ?>
