    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div id="content_timeline">
                <form action="cr_page.php?id=<?php echo $user_id;?>" method="post" id="f">
                <h2>Create a Page </h2><br/>
                <textarea cols="28" rows="2" name="page_name" placeholder="Page Name" required="required"></textarea><br/>
                <textarea cols="98" rows="5" name="page_content" placeholder="What you want to share?" required="required"></textarea><br/>
                <input type="submit" name="sub" value="Share on Page"/>
                </form>
                <?php 
                include("functions/functions_crpage.php");
                ?>
                
                   </br><center><h2>  Page Details </h2></center></br>
                    <?php include("functions/function_getcrpages.php") ?>
